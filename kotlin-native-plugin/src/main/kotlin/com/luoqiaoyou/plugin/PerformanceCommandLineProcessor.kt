...
class PerformanceCommandLineProcessor : CommandLineProcessor {
    /**
     * Just needs to be consistent with the key for PerformanceGradlePlugin#getCompilerPluginId
     */
    override val pluginId: String = "performance"

    /**
     * Should match up with the options we return from our PerformanceGradlePlugin.
